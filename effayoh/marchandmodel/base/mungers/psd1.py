...
item_attribute_factor = {
    (BARLEY, ENDING_STOCKS): 1000.0,
    (CORN, ENDING_STOCKS): 1000.0,
    (MILLET, ENDING_STOCKS): 1000.0,
    (MIXED_GRAIN, ENDING_STOCKS): 1000.0,
    (OATS, ENDING_STOCKS): 1000.0,
    (RICE_MILLED, ENDING_STOCKS): 1000.0,
    (RYE, ENDING_STOCKS): 1000.0,
    (SORGHUM, ENDING_STOCKS): 1000.0,
    (WHEAT, ENDING_STOCKS): 1000.0
}


class BasePSDMunger1(PSDMunger):
